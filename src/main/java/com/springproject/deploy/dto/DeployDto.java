...
public class DeployDto {
	...
	public int getSeqTableNo() {
		return seqTableNo;
	}

	public void setSeqTableNo(int seqTableNo) {
		this.seqTableNo = seqTableNo;
	}
	...
	public void setwProgram(String wProgram) {
