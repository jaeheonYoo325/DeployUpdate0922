...
function useEmp(empNo,empName){
   var str=window.location.search.slice(window.location.search.indexOf('=')+1);
   if(str=='req'){
      opener.document.getElementById("reqServiceName").value=empName
   }
   else if(str=='wEmp'){
      opener.document.getElementById("wEmpName").value=empName
   }
   else if(str=='reqEmp'){
      opener.document.getElementById("reqEmpName").value=empName
   }
   else if(str=='deployEmp'){
      opener.document.getElementById("deployEmpName").value=empName
   }
   else if(str=='devEmp'){
      opener.document.getElementById("devEmpName").value=empName
   }
   else if(str=='testEmp'){
      opener.document.getElementById("testEmpName").value=empName
   }
   else if(str=='prdEmp'){
      opener.document.getElementById("prdEmpName").value=empName
   }
   window.close();
}
</script>
